...
public partial class Member_RegOrder : BLL.TranslationBase
{
    ...
    public void setProductMenu(string storID)
    {
        ...
        this.menuLabel.Text = myTree.getMenuStore(storID, 3, 0);
    }

    public string GetStoreId()
    {
        return ((MemberInfoModel)Session["mbreginfo"]).StoreID;
    }
