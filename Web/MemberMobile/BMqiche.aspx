<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BMqiche.aspx.cs" Inherits="MemberMobile_BMqiche" %>
...
<body style="padding-top:50px" >
    ...
    <div class="cont_p" id="div2">
        <div id="yc2"><%=GetTran("010495", "省份:")%><asp:DropDownList CssClass="form-control" ID="qdz" runat="server" AutoPostBack="true" OnSelectedIndexChanged="qdz_SelectedIndexChanged"></asp:DropDownList></div>
        <div id="yc1" style="display:none;">
         <%=GetTran("010496", "出发城市:")%><asp:DropDownList CssClass="form-control" ID="cfcs" runat="server"></asp:DropDownList>
            <br />
         <asp:DropDownList ID="xz" runat="server" CssClass="form-control" Visible="false"></asp:DropDownList><asp:Button runat="server" ID="qrsf" Text="确认" OnClick="qrsf_Click"/>
            <br />
            </div>
            <div id="yc11" style="display:none;">
              <%=GetTran("010374", "终点站:")%><asp:DropDownList CssClass="form-control" ID="zdz" runat="server" AutoPostBack="true" OnSelectedIndexChanged="zdz_SelectedIndexChanged">
        </asp:DropDownList>
                </div>
            <div id="yc22" style="display:none;">
            <br />        <%=GetTran("010497", "商品选择:")%><asp:DropDownList ID="mc" CssClass="form-control" runat="server">
        </asp:DropDownList>
            <br />
        ...
        <%=GetTran("010498", "车票选择:")%><asp:DropDownList CssClass="form-control" ID="hxxz" runat="server"  AutoPostBack="true"  OnSelectedIndexChanged="hxxz_SelectedIndexChanged">
        </asp:DropDownList>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button ID="cz" runat="server" class="btn btn-primary" Text="支付" OnClick="cz_Click" />
