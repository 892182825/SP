...
public partial class MemberMobile_PageSj : System.Web.UI.UserControl
{
    /// <summary>
    ...
    public MemberMobile_PageSj()
    { }

    public MemberMobile_PageSj(int pageindex, int pagesize, string pagetable, string pageColumn, string condition, string key, string controlname)
    {
