...
public partial class Selldetails : BLL.TranslationBase
{
    ...
    public string GetSHStatejdt(int st)
    {
        ...
        if (st == 0) res = "<div style='width:25%;'> </div>";
         if (st == 1) res = "<div style='width:50%; '> </div>";
        if (st == 2) res = "<div style='width:25%;background-color:#999; '> </div>";
        if (  st == 3 || st == 11) res = "<div style='width:75%; '> </div>";
