<%@ Page Language="C#" AutoEventWireup="true" CodeFile="feijianx.aspx.cs" Inherits="MemberMobile_feijianx" %>
    ...
    <form id="form2" runat="server">
        <div class="navbar navbar-default" role="navigation">
            <div class="navbar-inner">
                ...
                <span style="color: #fff; font-size: 18px; margin-left: 30%; text-shadow: 2px 2px 5px hsl(0, 0%, 61%);">废件箱</span>
            </div>
        </div>
        ...
        <div class="middle">
          ...
          <script>
              ...
              function getNext() {
                  ...
                  var res = AjaxClass.feijianxiangDetail(cupindex).value;
                  if (res != "") {
