<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fajianx.aspx.cs" Inherits="MemberMobile_fajianx" %>
    ...
    <form id="form2" runat="server">
        ...
        <div style="overflow: hidden;display:none;">
            <div id="qq2" class="fiveSquareBox clearfix searchFactor">
                <span style=" overflow: hidden">
                    <span style="float: left" class="rq"><%=GetTran("001285", "发件日期")%>：</span>
        ...
        <script>
            ...
            function getNext() {
                ...
                var res = AjaxClass.fajianxiangDetail(cupindex).value;
                if (res != "") {
