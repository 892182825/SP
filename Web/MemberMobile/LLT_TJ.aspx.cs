...
public partial class LLT_TJ : BLL.TranslationBase
{
    ...
    public void BindData()
    {
        ...
        object[] obj = WTreeBLL.GetLLTTree_II(qs, EndNumber, StartNumber, "3", "0");

        SqlDataReader dr = (SqlDataReader)obj[0];

        while (dr.Read())
        {
            GridView1.Columns[0].HeaderText = GetTran("007321", "推荐结构");
        ...
        SetLianLuTu(StartNumber, Session["M_L_TJ"].ToString(), qs, SfType.getBH());
    }
