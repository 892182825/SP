<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegOrderAgain.aspx.cs" Inherits="Member_RegOrderAgain" %>
		...
		{			
		 ...
		 function ShowProductDiv(sender,pid)
            ...
            function GetCart(sender,pid)
            {
                ...
                if (obj)
                { 
                    //alert(sender.value==0);
                    if(sender.value==0)
                    {
                        var flag=AjaxMemShopCart.DelOneFx(pid,"1").value;
                    }
                    else
                    {
                         flagStr=AjaxMemShopCart.UpdShopCartFx(pid,sender.value,"1").value;
                    }
                }
            } 
    </script>
        ...
        <tr>
            <td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#D6EDE6"
                    ...
                    <tr>
                        <td align="left">
                            <a href="ShopingListAgain.aspx" style="text-decoration:underline; padding-left:10px;">切换</a>
