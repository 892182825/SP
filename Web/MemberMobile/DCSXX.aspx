<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DCSXX.aspx.cs" Inherits="MemberMobile_DCSXX" %>
...
<body>
    ...
    <form id="form1" runat="server" name="form1" method="post">
        ...
        <div class="moneyInfo3" style="left: 0px; overflow: hidden; zoom: 1; width: 100%; background-color: #fff">
            ...
            <a href="DetailDCS.aspx" class="moneyInfoSlt"><%=GetTran("8139","待查收") %></a>
            ...
            <div class="changeBox zcMsg">
                <ul>
                    ...
                    <li style="font-size: 18px">
                        ...
                        <div class="changeRt">
                            <%--  <asp:TextBox ID="HkTime" CssClass="textBox" runat="server"
                            MaxLength="50"></asp:TextBox>--%>
                           <%-- <asp:Label ID="HkTime" runat="server" Text="Label"></asp:Label>--%>
