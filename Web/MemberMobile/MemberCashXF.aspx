...
<body>
    ...
    <form id="form2" runat="server">
        ...
        <div class="middle" style="margin-top: 50px;background-color:#111622;color:#fff;">
            <div class="changeBox zcMsg" style="position: relative; margin-top: 10px;background-color:#111622;color:#fff;">
                <div>
                ...
                <ul>
                    ...
                    <li>
                        <div class="changeLt" style="font-size: 16px;color:#fff;">兑换数量：</div>
                        <div class="changeRt">
                            <div>
                    ...
                    <li>
                        <div class="changeLt" style="font-size: 16px;color:#fff;">云端余额：</div>
                        <div class="changeRt">
                            <asp:Label ID="rmoney" runat="server" ForeColor="Red"></asp:Label>
                        </div>
                    </li>
                    <li>
                        <div class="changeLt" style="font-size: 16px;color:#fff;">钱包余额：</div>
                        <div class="changeRt">
                    ...
                    <li>
                        <div class="changeLt" style="font-size: 16px;color:#fff;">币种选择：</div>
                        
                        <div class="changeRt"><asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal" meta:resourcekey="RadioButtonList1Resource1">
