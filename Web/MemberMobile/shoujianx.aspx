<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shoujianx.aspx.cs" Inherits="MemberMobile_shoujianx" %>
    ...
    <form id="form2" runat="server">
        ...
        <div style="overflow: hidden;display:none;">
            <div id="qq2" class="fiveSquareBox clearfix searchFactor">
                <span style=" overflow: hidden">
                    <span style="float: left" class="rq"><%=GetTran("001259", "收件日期")%>：</span>
        ...
        <script>
            ...
            function getNext() {
                ...
                var res = AjaxClass.shoujianxiangDetail(cupindex).value;
                if (res != "") {
