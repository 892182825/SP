...
public partial class Member_RegOrderAgain : BLL.TranslationBase
{
    ...
    public void setProductMenu(string storID)
    {
        ...
        this.menuLabel.Text = myTree.getMenuStoreFx(storID, 3, 1);
    }

    public string GetStoreId()
    {
        return ((OrderFinalModel)Session["fxMemberModel"]).StoreID;
    }
    ...
    {
        Response.Redirect("ShoppingCartViewAgain.aspx?tt1=tree");
    }
}
