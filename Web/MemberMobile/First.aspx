  ...
  <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick"></asp:AsyncPostBackTrigger>
        ...
        <div style="width: 90%;height:70px;margin-top: 96px;margin-left: 5%;">
                  ...
                  <a style="float:left;width:24%;height:55px;text-align:center;font-size:14px;margin-top:3px;color: #666;" href="../MemberMobile/SST_TJ.aspx">
                      <img src="images/zhuanzhk.png" width="32" height="32"  /><br />團隊
                      
                  </a>
                  <a style="float:left;width:24%;height:55px;text-align:center;font-size:14px;margin-top:3px;color: #666;" href="">
                      <img src="images/bzsz.png" width="32" height="32"  /><br />幣幣
                  </a>
              </div>
              ...
              <div style="width:90%;height:300px;margin-top:20px;margin-left:5%">
                  ...
                  <div  class="dv1">
                      <div  class="dv2"><a href="../MemberMobile/AccountDetail.aspx?type=AccountXJ" style="text-decoration: underline;color: #666;" >會員級別</a></div>
       ...
       <div  class="dv1">   <div  class="dv2"><a href="../MemberMobile/AccountDetail.aspx?type=A" style="text-decoration: underline;color: #666;" >A幣賬戶</a></div> 
                      <div  class="dv3"><asp:Label ID="lblPointA" runat="server" Text="0.00"></asp:Label></div> 
        </div>

                   <div  class="dv1">   <div  class="dv2"><a href="../MemberMobile/AccountDetail.aspx?type=B" style="text-decoration: underline;color: #666;" >B幣賬戶</a></div> 
                      <div  class="dv3"><asp:Label ID="lblPointB" runat="server" Text="0.00"></asp:Label></div> 
        </div>

                   <div  class="dv1">   <div  class="dv2"><a href="../MemberMobile/AccountDetail.aspx?type=C" style="text-decoration: underline;color: #666;" >C幣賬戶</a></div> 
                      <div  class="dv3"><asp:Label ID="lblPointC" runat="server" Text="0.00"></asp:Label></div> 
        </div>

                   <div  class="dv1">   <div  class="dv2"><a href="../MemberMobile/AccountDetail.aspx?type=D" style="text-decoration: underline;color: #666;" >D幣賬戶</a></div> 
                      <div  class="dv3"><asp:Label ID="lblPointD" runat="server" Text="0.00"></asp:Label></div> 
        </div>

                   <div  class="dv1">   <div  class="dv2"><a href="../MemberMobile/AccountDetail.aspx?type=E" style="text-decoration: underline;color: #666;" >E幣賬戶</a></div> 
                  ...
                  <div style="box-shadow: #e8e5e5 0px 0px 10px;width:100%;height:70px;background-color:#f9f9ff;margin-top:10px">
                      <div style="margin-left: 10px;font-size:18px;padding-top: 23px;font-weight:bold;"><a href="../MemberMobile/AccountDetail.aspx?type=AccountFXth" style="text-decoration: underline;color: #666;" >團隊業績</a></div>
