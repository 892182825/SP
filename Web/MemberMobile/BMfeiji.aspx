<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BMfeiji.aspx.cs" Inherits="MemberMobile_BMfeiji" %>
...
<body  style="padding-top:50px" >
    ...
    <div class="cont_p" id="div2">
        <div id="yc2"><asp:Button ID="cyx" runat="server" Text="查询飞机票商品列表" OnClick="cyx_Click" /></div>
        ...
        <%=GetTran("010372","商品选择:") %><asp:DropDownList CssClass="form-control" ID="mc" runat="server">
         ...
         <%=GetTran("010373","起点站:") %><asp:DropDownList CssClass="form-control" ID="qdz" runat="server"></asp:DropDownList>     <%=GetTran("010374","终点站:") %><asp:DropDownList CssClass="form-control" ID="zdz" runat="server">
            ...
            <br />
         <%=GetTran("010375","起飞日期:") %><asp:TextBox ID="txtBeginTime" runat="server" CssClass="Wdate" onfocus="WdatePicker()"  Style=""></asp:TextBox>
            <asp:Button ID="cyxlb" runat="server" Text="选择" OnClick="cyxlb_Click" /> </div>
        <br />
        <div id="yc3" style="display:none">
         <%=GetTran("010376","航线选择:") %><asp:DropDownList CssClass="form-control" ID="hxxz" runat="server" AutoPostBack="true" OnSelectedIndexChanged="hxxz_SelectedIndexChanged">
        </asp:DropDownList>
            舱位选择:<asp:DropDownList CssClass="form-control" ID="cwxz" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cwxz_SelectedIndexChanged">
        </asp:DropDownList>
        ...
        <asp:Button ID="cz" runat="server" Text="购买" OnClick="cz_Click" />
