...
public partial class Member_ShowNetworkViewNewTJ : BLL.TranslationBase
{
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Session["jgbh"] != null)
            {
                if (Session["jgbh"].ToString() != "")
                {
                    ...
                    string loginBh = Session["Member"].ToString();
                    int bhCw = AjaxClass.GetLogoutCw1(this.txtbianhao.Text.Trim(), Convert.ToInt32(this.dropdownlist_qishu.SelectedValue),false);
                    int loginCw = AjaxClass.GetLogoutCw1(loginBh, Convert.ToInt32(this.dropdownlist_qishu.SelectedValue),false);
    ...
    protected void button1_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Write("<script>alert('请输入会员编号！');</script>");
            return;
        }
        else
        ...
        this.WangLuoTu(bianhao, "",0, cengshu, Convert.ToInt32(dropdownlist_qishu.SelectedValue), "");
    ...
    {
        Response.Redirect("MemberNetMap.aspx?net=" + Session["jglx"] + "&bianhao=" + this.txtbianhao.Text.Trim().ToString() + "&SelectGrass=" + this.dropdownlist_qishu.SelectedValue);
    }
    ...
    protected void Button6_Click(object sender, EventArgs e)
    {
        ...
        Session["jglx"] = "az";
        Session["xqbh"] = Session["jgbh"];
        Response.Redirect("ShowNetworkViewNew.aspx?cengshu=" + this.txtceng.Text.Trim() + "&SelectGrass=" + dropdownlist_qishu.SelectedValue.ToString() + "&isanzhi=1");
    }
}
