<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BindingMobilePhone.aspx.cs" Inherits="MemberMobile_PhoneSettings_BindingMobilePhone" EnableEventValidation="false" %>
        ...
        $(function () {
            $("#txtTele").blur(function () {
                ...
                if (!phoneCheck.test($("#txtTele").val())) {
                    webToast("手机号码格式有误，请重新输入", "middle", 3000);
                    document.getElementById("txtTele").style.borderColor = "#b94a48";
                    return;
                }
                else {
        ...
        <div>
            <div class="navbar navbar-default" role="navigation">
                <div class="navbar-inner">
                    ...
                    <span style="color: #fff; font-size: 18px; margin-left: 25%; text-shadow: 2px 2px 5px hsl(0, 0%, 61%); font-weight: 600;">更换绑定手机</span>
                </div>
            </div>
            ...
            <div class="middle" style="margin-top:20px;">
                <ul>
                    <li style="height: auto;" runat="server" id="libindtel" visible="false">
                        <div class="input-group col-md-4">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
                            <asp:TextBox ID="txtBindtel" CssClass="form-control" MaxLength="11" ReadOnly="true" runat="server"></asp:TextBox>
                            <asp:HiddenField ID="HFBindtel" runat="server" />
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="input-group col-md-4">
                            ...
                            <asp:TextBox ID="txtTele" CssClass="form-control" onkeypress="return kpyzsz();" onkeyup="   szxs(this);" onafterpaste="szxs(this)" placeholder="手机号码" runat="server" MaxLength="11" meta:resourcekey="txtTeleResource1"></asp:TextBox>
                        </div>
                        <span id="info_txtTele" style="display: none;" class="re_pro"></span>
                    </li>
                </ul>
            </div>
