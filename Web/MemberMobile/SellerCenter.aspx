        ...
        <div class="middle">
            ...
            <div class="content buy" id="buy">
                <ul>
                    ...
                    <li>
                        <div class="changeLt">买入名称：</div>
                        <div class="changeRt">
                            <asp:Label ID="lbljbb" runat="server" Text="石斛积分"></asp:Label>
                        </div>
                    </li>

                    <li>
                        <div class="changeLt">买入金额：</div>
                        <div class="changeRt">
                    ...
                    <li style ="height:auto; padding:5px;color:#177cf6;" >
                        交易提醒：买入挂单成功后，请实时关注单据状态，如有匹配到交易对方，请务必在两小时内按照交易对方提供的收款账户完成转账汇款，待交易对方确认收到款项后点击确认收款，本次交易方可完成。
                  如果您未在两小时内完成汇款，系统将对您的行为进行惩罚要扣除一定比例的违约金，请您慎重交易 </li>
            ...
            <div class="content sell" id="sell">
                <ul>
                    ...
                    <li>
                        <div class="changeLt">卖出名称：</div>
                        <div class="changeRt">
                            <asp:Label ID="Label1" runat="server" Text="石斛积分"></asp:Label>
                    ...
                    <li>
                        ...
                        <div class="changeRt">
                            <asp:Label ID="lblmaxsell" runat="server" Text="0.00"></asp:Label>
                        </div>
                    </li>

                    <li>
                        <div class="changeLt">卖出金额：</div>
                        <div class="changeRt">
...
<script type="text/javascript">
    ...
    function Fosub(ecountid, showid, subtype, issell) {
        ...
        var changem = 300;
        var mrmax = '<%=mrmax%>';
        var canbuy = parseInt(mrmax);
        var mcmax = '<%=mcmax%>';
        var cans = parseInt(mcmax);
