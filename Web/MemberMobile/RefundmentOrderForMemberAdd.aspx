<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RefundmentOrderForMemberAdd.aspx.cs"
 Inherits="ProductOrders_RefundmentOrderBrowseForMember" EnableEventValidation="false"  %>
...
//<input type='checkbox' id='chkAll' onclick='FunCheckOrUnCheckAll(this);'"
    ...
    <style type="text/css">
        ...
        .frameclass{width:800px;overflow-x:auto; overflow-y:scroll;word-break:break-all; display :none;
 ...
 text-align:left;
    ...
    .titleM{font-size:10pt;font-weight:bold;
                            padding-top:4px;padding-bottom:4px;text-align:center;background-color: #CAE1D9}
...
<body  >
    ...
    <asp:Panel ID="pnl_title" runat="server" Visible="true" >
                        <tr class="ctConPgTab">
                            <td colspan="4" align="center" nowrap="nowrap" >                              
                             会员退货<asp:Label ID="lblDealingOrderID" runat="server" ></asp:Label><asp:Label ID="lbl_Title" runat="server" ></asp:Label></td>
                        </tr>
   </asp:Panel>
                        <tr>
                        <td align="center" >
    ...
    <table width="99%" class="biaozzi" border="0" cellpadding="0" cellspacing="0" style="word-break: keep-all;
        ...
        <tr>
            <td>
                ...
                <asp:DropDownList ID="ddlContion" runat="server" Style="word-break: keep-all; word-wrap: normal;"
                    ...
                    <asp:ListItem Value="A.StoreId">店铺编号</asp:ListItem>
                ...
                <asp:TextBox ID="txtContent" CssClass="ctConPgTxt" runat="server" Width="207px"></asp:TextBox>&nbsp;&nbsp;
                ...
                <asp:GridView ID="gv_browOrder" runat="server" AutoGenerateColumns="False"  CellSpacing="1"
                  Width="100%" onrowcommand="gv_browOrder_RowCommand"  onrowdatabound="gv_browOrder_RowDataBound"   ondatabound="gv_browOrder_DataBound">
                    ...
                    <Columns>
                       <asp:TemplateField HeaderText="退货">
                                            <ItemTemplate>                                                                                                   
                                              ...
                                              <asp:LinkButton ID="lbtn_Refundment" runat="server" CommandName ="refund" CommandArgument='<%# Eval("OrderId") %>' Text="退货"></asp:LinkButton>
                                            </ItemTemplate>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <%# Encryption.Encryption.GetDecipherName(Eval("name").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="报单时间" ItemStyle-Wrap="false">
                           ...
                           <asp:TemplateField HeaderText="查看明细" >    
                            <ItemStyle HorizontalAlign="Center" />                      
                              <ItemTemplate>
                                <asp:ImageButton ID="lbtn_Details" runat="server" ImageUrl="images/view-button.png"  CommandArgument='<%#Eval("OrderId") %>' 
     ...
     <uc2:Pager ID="Pager1" runat="server" />
            <asp:Button ID="btn_ReturnConfrim" runat="server" CssClass="anyes" Visible="false" 
                ...
                &nbsp; <input id="btnBack" value="返回" class="anyes" type="button" onclick="javascript:window.location.href='RefundmentOrderForMemberList.aspx';"/>
    </asp:Panel>
                        ...
                        <td class="cell3_2">
                            ...
                            <asp:Label ID="lbl_MemberTotalMoney" runat="server"></asp:Label>
                                ...
                                <td style="text-align:center;">
                                    领取奖金总额</td>
                                <td colspan="2"  style="text-align:center;">                               
                            <asp:Label ID="lbl_MemberJJ" runat="server"></asp:Label>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="退货数量">
                                                <ItemTemplate>
                                                 ...
                                                 <asp:ImageButton ID="imgBtnUp" CommandName="add" CommandArgument='<%# Eval("OrderId")+"_"+Eval("ProductID") %>' runat="server"  ImageUrl="../images/QuantityAdd.gif" AlternateText="数量加1" />
                                                 ...
                                                 <asp:ImageButton ID="imgBtnSub" CommandName="sub"  runat="server" ImageUrl="../images/QuantitySub.gif" AlternateText="数量减1" /></td>
                                                 </tr>
                                                 </table>
