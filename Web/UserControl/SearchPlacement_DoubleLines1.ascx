<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchPlacement_DoubleLines1.ascx.cs"
    Inherits="UserControl_SearchPlacement_TwoLines1" %>
<!--  引用用户控件页面需引用以下样式
...
//            alert('请填写推荐编号！');
       ...
       else
       {
           ...
           var result=AjaxClass.SearchPlacement_DoubleLines(txtSb.toString(),floorCount).value;
...
<%--<div class="changeLt">
    <b>*</b>
    <%=tran.GetTran("000027","安置编号")%>：</div>
                     <div class="changeRt">
 <input type="hidden" value="" id="hdTopNumber" />
            <asp:TextBox ID="Txttj" Width="87px" runat="server" MaxLength="50" Style="display: none;"></asp:TextBox>
            <asp:TextBox ID="txtPlaceMent" CssClass="textBox"  MaxLength="50" runat="server"></asp:TextBox>
            &nbsp;
...
<div class="input-group col-md-4">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-link yellow"></i></span>
 <input type="hidden" value="" id="hdTopNumber" />
            <asp:TextBox ID="Txttj" Width="87px" runat="server" MaxLength="50" Style="display: none;"></asp:TextBox>
            <asp:TextBox ID="txtPlaceMent" CssClass="form-control azbh" placeholder="安置编号"  MaxLength="50" runat="server"></asp:TextBox>
            
                
            <input name="btnSearch" type="button"  style="background: #85ac07;display:none;" id="Button1" class="btn2" onclick="SearchPlacement('',0);hidselect(0);"  value='<%=tran.GetTran("005861","寻找安置人") %>' />
            <input type="hidden" runat="server" id="HidAz" />
            <input type="hidden" runat="server" value="1" id="HidDistrict" />
</div>
