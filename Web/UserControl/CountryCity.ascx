<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CountryCity.ascx.cs" Inherits="UserControl_CountryCity" %>
...
<script type="text/javascript" language="javascript">
    function GetCCode(objid1, objid2, objid3, objid4) {
        ...
        var city = obj3.value;
        var xian = obj4.value;
        if (c != '<%=tran.GetTran("000303","请选择") %>' && p != '<%=tran.GetTran("000303","请选择") %>' && city != '<%=tran.GetTran("000303","请选择") %>' && xian != '<%=tran.GetTran("000303","请选择") %>') {
            GetCCode_s2(xian);
        }
    }
    ...
    function DropDownGetData(obj, objvalue) {
        ...
        if (document.all) {
            ...
            try {
                ...
                newOption.text = '<%=tran.GetTran("000303","请选择") %>';
                newOption.value = '<%=tran.GetTran("000303","请选择") %>';
            ...
            if (xmlDoc.documentElement.tagName != "parsererror") {
                ...
                try {
                    ...
                    var newOption = new Option('<%=tran.GetTran("000303","请选择") %>', '<%=tran.GetTran("000303","请选择") %>');
...
<span style="display:block;  float:left;margin-right:2px;border: 1px solid #ccc;"><asp:DropDownList ID="ddlCountry" runat="server" CssClass="ctConPgFor" DataTextField="Name" draw="m_country" Width="90px"
    DataValueField="Name" OnDataBound="ddlCountry_DataBound" >
</asp:DropDownList></span>
<span style="display:block;  float:left;margin-right:2px;border: 1px solid #ccc;"><asp:DropDownList ID="ddlP" runat="server" CssClass="ctConPgFor" DataTextField="Province" draw="m_province"  Width="90px"
    DataValueField="Province" OnDataBound="ddlP_DataBound">
</asp:DropDownList></span>
<span style="display:block;  float:left;margin-right:2px;border: 1px solid #ccc;"><asp:DropDownList ID="ddlCity" runat="server" CssClass="ctConPgFor" DataTextField="City"  draw="m_city"  Width="90px"
    DataValueField="City" OnDataBound="ddlCity_DataBound">
</asp:DropDownList></span>
<span style="display:block;  float:left;margin-right:2px;border: 1px solid #ccc;"><asp:DropDownList ID="ddlX" runat="server" style="
            /*min-height: 60px;*/
            height: auto;" DataTextField="Xian"  draw="m_xian"  Width="90px"
    DataValueField="Xian" OnDataBound="ddlXian_DataBound">
</asp:DropDownList></span>
<table   style="DISPLAY: none" border="0" cellspacing="0" cellpadding="0">
  
	<tr >
		<td><asp:textbox id="TextGuojia" runat="server" Width="10"></asp:textbox></td>
