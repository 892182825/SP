...
public partial class UserControl_CountryCity : UserControlBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            MyId = ((UserControl_CountryCity)sender).ID.ToString();
            ...
            {
                BindGuojia("");
                this.ddlP.Items.Insert(0, new ListItem(tran.GetTran("000303", "请选择"), tran.GetTran("000303", "请选择")));
                this.ddlCity.Items.Insert(0, new ListItem(tran.GetTran("000303", "请选择"), tran.GetTran("000303", "请选择")));
                this.ddlX.Items.Insert(0, new ListItem(tran.GetTran("000303", "请选择"), tran.GetTran("000303", "请选择")));
            }
        }
        else
        {
    ...
    {
        if (this.TextGuojia.Text == "" || this.TextGuojia.Text == tran.GetTran("000303", "请选择"))
        {
            return false;
        }
        else if (this.TextShenFen.Text == "" || this.TextShenFen.Text == tran.GetTran("000303", "请选择"))
        {
            return false;
        }
        else if (this.TextCity.Text == "" || this.TextCity.Text == tran.GetTran("000303", "请选择"))
        {
            return false;
        }
        else if (this.TextXian.Text == "" || this.TextXian.Text == tran.GetTran("000303", "请选择"))
        {
            return false;
        }
        else
