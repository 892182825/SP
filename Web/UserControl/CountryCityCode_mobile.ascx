<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CountryCityCode_mobile.ascx.cs" Inherits="UserControl_CountryCityCode_mobile" %>
...
<div style="width:100%; padding-top:5px;" id="dv_cpc" runat="server">
<span style="float:left;margin-right:1%;width:49%"><asp:DropDownList ID="ddlCountry" CssClass="ctConPgFor" runat="server" DataTextField="Name" draw="m_country" Width="100%"
    DataValueField="Name" OnDataBound="ddlCountry_DataBound" >
</asp:DropDownList></span>
<span style="float:left;width:49%;margin:0;"><asp:DropDownList ID="ddlP" CssClass="ctConPgFor" runat="server" DataTextField="Province" draw="m_province"  Width="100%"
    DataValueField="Province" OnDataBound="ddlP_DataBound">
</asp:DropDownList></span>

<span style="float:left;margin-right:1%;width:49%"><asp:DropDownList ID="ddlCity" CssClass="ctConPgFor" runat="server" DataTextField="City"  draw="m_city"  Width="100%"
    DataValueField="City" OnDataBound="ddlCity_DataBound">
</asp:DropDownList></span>
<span style="float:left;width:49%;margin:0;"><asp:DropDownList ID="ddlX" CssClass="ctConPgFor" runat="server" DataTextField="Xian"  draw="m_xian"  Width="100%"
