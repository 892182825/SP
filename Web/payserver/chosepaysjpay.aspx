<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chosepaysjpay.aspx.cs" Inherits="chosepaysjpay" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(function () {
            ...
            $("#rdofxpay").blur(function () {
                var lb = parseFloat($("#lbltotalmoney").text());
                var fx = parseFloat($("#rdofxpay").val());
                if (fx < lb*0.5 || fx > lb) {
                    
                    $("#rdofxpay").val(lb);
                    $("#rdoxjpay").val(0);
                    //$("#rdobxpay").val(0);
                    document.getElementById("rdofxpay").style.borderColor = "#b94a48";
                    alert('不能小于总量的50%或大于需要支付的金额。');
                    return;
                }
                else {
                    if (fx == "" || isNaN(fx)) {
                        ...
                        var bd = lb - fx;
                        $("#rdoxjpay").val(bd.toFixed(4));
                        document.getElementById("rdoxjpay").style.borderColor = "#468847";
                    }
                }
            });

            $("#rdoxjpay").blur(function () {
                var lb = parseFloat($("#lbltotalmoney").text());
                var xj = parseFloat($("#rdoxjpay").val());
                if (xj < 0 || xj > lb*0.5) {
                    
                    $("#rdofxpay").val(lb);
                    $("#rdoxjpay").val(0);
                    document.getElementById("rdoxjpay").style.borderColor = "#b94a48";
                    alert('不能小于0或大于需要支付的金额的50%。');
                    return;
                }
                else {
                    if (xj == "" || isNaN(xj)) {
...
<body>
    ...
    <div class="navbar navbar-default" role="navigation">
            <div class="navbar-inner">
                ...
                <span style="color: #fff; font-size: 18px; margin-left: 43%; text-shadow: 2px 2px 5px hsl(0, 0%, 61%);">支付	</span>
            </div>
        </div>
    <div class="ddInfo">
        <ul>
            <li style="background:none;min-height: 28px;">  本次支付  <asp:Label CssClass="buyfont" ID="lbltotalmoney" runat="server" Text="0.00"></asp:Label> <br /><asp:Label ID="lblpayjbb" runat="server" Text="" ></asp:Label>  </li>
        </ul>
    </div>    
    <div class="zfInfo">
        <asp:RadioButton ID="rdoectpay"  Checked="true" runat="server" GroupName="p"  Visible="false" />
        <ul>

         
            <li id="fxpay" runat="server"  class="zfInfo_3" style="height:auto">
               <span style="float:left;">现金钱包</span> <asp:TextBox ID="rdofxpay" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" Style="float: left;margin-top: 10px;" CssClass="form-control" Width="30%" runat="server" placeholder="请输入使用多少"></asp:TextBox><asp:Label ID="zcjf" runat="server" Text=""></asp:Label><span  class="blcsty"><span style="margin-right:10px;font-size:15px">可用余额:</span>&nbsp;&nbsp; <asp:Label ID="lblfxye" runat="server" Text="0.00"></asp:Label></span>
            </li> 
            <li id="xjpay" runat="server"  class="zfInfo_3" style="height:auto">
             <span style="float:left;">FTC钱包</span><asp:TextBox ID="rdoxjpay" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" Style="float: left;margin-top: 10px;" CssClass="form-control" Width="30%" runat="server" placeholder="请输入使用多少"></asp:TextBox> <asp:Label ID="lblshzf" runat="server" Text=""></asp:Label> <span  class="blcsty"><span style="margin-right:10px;font-size:15px">可用余额:</span>&nbsp;&nbsp; <asp:Label ID="lblkyxjye" style="font-size:16px;" runat="server" Text="0.0000" ></asp:Label></span>
            <asp:HiddenField ID="shjfzf" runat="server" Value="0" />
            </li>
            <li id="Li1" runat="server"  class="zfInfo_3" style="height:auto">
             <span style="float:left;">保险钱包</span> <asp:Label ID="lblbxjf" runat="server" Text=""></asp:Label> <span  class="blcsty"><span style="margin-right:10px;font-size:15px">可用余额:</span>&nbsp;&nbsp; <asp:Label ID="lblbxje" style="font-size:16px;" runat="server" Text="0.0000" ></asp:Label></span>
            <asp:HiddenField ID="HiddenField1" runat="server" Value="0" />
            </li>
             
             <li id="xfpay" runat="server" visible="false" class="zfInfo_3" style="height:auto">
               <span style="float:left;">   <asp:RadioButton ID="rdoxfpay" GroupName="m" runat="server" /></span><asp:Label ID="Label1" runat="server" Text=""></asp:Label><span  class="blcsty"><span style="margin-right:10px;font-size:15px">可用余额:</span>&nbsp;&nbsp; <asp:Label ID="lblxfye" runat="server" Text="0.00"></asp:Label></span>
            </li>
            <%--<li>
                   <asp:TextBox ID="txtadvpass" TextMode="Password" placeholder="二级密码" CssClass="form-control"
            ...
            <li style="display:none;" class="zfInfo_4">
	...
	<div class="zfInfo"  style="display:none;">
    	<ul>
    ...
    <ul>
        <li>
            <span><b class="TranToValue" style="font-weight: normal;"><%=GetTran("009095","二级密码") %></b>：</span>
            <span><input id="pwd" style="height:70%;width:90%;border: 1px solid #ccc;font-size:15px;background: #f8f8f8;" type="password" /></span>
        </li>
    </ul>
</div>
<div class="zfTag">
    <asp:Button ID="btnsure"  runat="server" Text="支  付" OnClick="btnsure_Click" style="width:100%;" CssClass="btn btn-primary btn-lg" />
</div>
