<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BackupDatabase.aspx.cs" Inherits="Company_BackupDatabase" %>
...
<body>
    <form id="form1" runat="server" onsubmit="filterSql_III()">
        ...
        <table width="100%">
			<tr>
				<td >				
					<table border="0" cellpadding="0" cellspacing="0" class="biaozzi">
				        ...
				        <tr>
					        <td align="center"><asp:TextBox id="txtPath" runat="server" Width="238px" MaxLength="30" Visible="false"></asp:TextBox><font color="red" style="display:none;">*</font>&nbsp;					        
						       &nbsp;&nbsp;
			        ...
			        <table border="0" cellpadding="0" cellspacing="0"  width="100%" class="biaozzi" >
						<tr >
						    <td align="center" ><FONT face="宋体" style="font-size:18px;"><%=GetTran("004192","数 据 库 备 份" )%></FONT>&nbsp;&nbsp;&nbsp;					    				
			...
			<tr>
			    <td>
			        <asp:label id="lblMessage" Runat="server" style="font-size:12px;"></asp:label>
				</td>								        
			</tr>
