<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalaryGrantView.aspx.cs" Inherits="Company_SalaryGrantView" %>
...
<%--                                    <asp:TemplateField HeaderText="时间">
           ...
           <asp:BoundField DataField="Bonus5" HeaderText="永续奖" DataFormatString="{0:f2}"></asp:BoundField> 
                                                            ...
                                                            <asp:BoundField DataField="Bonus6" HeaderText="进步奖" DataFormatString="{0:f2}"></asp:BoundField>
             <asp:BoundField DataField="Kougl" HeaderText="网平台综合管理费" DataFormatString="{0:f2}"></asp:BoundField>          
                                                     <asp:BoundField DataField="Koufl" HeaderText="网扣福利奖金" DataFormatString="{0:f2}"></asp:BoundField>
                                     <asp:BoundField DataField="Koufx" HeaderText="网扣重复消费" DataFormatString="{0:f2}"></asp:BoundField> 
