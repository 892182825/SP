<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportProfit.aspx.cs" Inherits="Company_ReportProfit" %>
        ...
        <tr>
            <td>
                ...
                <table width="" border="0" cellpadding="0" cellspacing="0" class="biaozzi">
                    <tr>
                    <td><asp:Button ID="btnE" runat="server" Text="添加报溢" CssClass="anyes" 
                            onclick="btnE_Click" /> &nbsp;</td>
                        <td>
                    ...
                    <tr>
                        <td style="padding-left: 20px">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        1、<%=GetTran("007155", "根据条件查询各个仓库的报溢单情况")%>
                                    </td>
                                    
                                </tr>
                                <tr>
                                    <td>
                                        2、<%=GetTran("007156", "可对各仓库的产品进报溢操作")%>。
                                    </td>
