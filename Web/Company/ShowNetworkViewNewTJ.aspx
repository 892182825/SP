<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowNetworkViewNewTJ.aspx.cs"
    Inherits="Company_ShowNetworkViewNewTJ" EnableViewStateMac="false" %>
...
<head>
    ...
    function down_tw(e,th)
    {
        if(e.button==1 || e.button==0)
        {
            if(istw)
            {
                ...
                {
                    setAjaxTW("LayerBit2","Ordinal2",btid,id,'<%=ViewState["qs"]%>','<%=ViewState["cengshu"]%>','<%=ViewState["startbh"]%>','<%=ViewState["isanzhi"]%>');
                }
                /*else
    ...
    <table id="menus" class="box" style="display: none" bh="" cellpadding="0" cellspacing="0">
        <tr id="tr10">
            <td width="30" bgcolor="#EFEDDE" class="STYLE1">
                <img src="images/icon_2.gif" width="14" height="14" />
            </td>
            <td bgcolor="#FFFFFF" class="STYLE1" onclick="fun1(document.getElementById('menus').bh,1,document.getElementById('menus').Qishu)">
                <%=GetTran("000806", "编号变色")%>
            </td>
        </tr>
        <tr id="tr19">
            <td bgcolor="#EFEDDE" class="STYLE1">
                <img src="images/icon_8.gif" width="14" height="14" />
            </td>
            <td bgcolor="#FFFFFF" class="STYLE1" onclick="fun1(document.getElementById('menus').bh,15,document.getElementById('menus').Qishu)">
                取消变色
            </td>
        </tr>
        <tr id="tr11">
            <td bgcolor="#EFEDDE" class="STYLE1">
                <img src="images/icon_1.gif" width="14" height="14" />
            </td>
            <td bgcolor="#FFFFFF" class="STYLE1" onclick="fun1(document.getElementById('menus').bh,2,document.getElementById('menus').Qishu)">
                <%=GetTran("000809", "会员注册")%>
            </td>
        </tr>
        <tr style="display: none" id="tr12">
            <td bgcolor="#EFEDDE" class="STYLE1">
                <img src="images/icon_5.gif" width="14" height="14" />
            </td>
            <td bgcolor="#FFFFFF" class="STYLE1" onclick="fun1(document.getElementById('menus').bh,3,document.getElementById('menus').Qishu)">
                <%=GetTran("000812", "审核会员")%>
            </td>
        </tr>
        <tr id="tr13">
            ...
            <td bgcolor="#FFFFFF" class="STYLE1" onclick="fun1(document.getElementById('menus').bh,4,document.getElementById('menus').Qishu)">
                <%=GetTran("000815", "会员删除")%>
            </td>
        </tr>
        <tr id="tr23">
            ...
            <td bgcolor="#FFFFFF" class="STYLE1" onclick="fun1(document.getElementById('menus').bh,16,document.getElementById('menus').Qishu)">
                <%=GetTran("001282", "会员注销")%>
            </td>
        </tr>
        <tr id="tr14" style="display: none">
            <td bgcolor="#EFEDDE" class="STYLE1">
                <img src="images/icon_4.gif" width="14" height="14" />
            </td>
            <td bgcolor="#FFFFFF" class="STYLE1" onclick="fun1(document.getElementById('menus').bh,5,document.getElementById('menus').Qishu)">
                <%=GetTran("000772", "会员调网")%>
            </td>
        </tr>
        <tr id="tr6">
            ...
            <td bgcolor="#FFFFFF" class="STYLE1" onclick="fun1(document.getElementById('menus').bh,17,document.getElementById('menus').Qishu)">
                <%=GetTran("001209", "信息修改")%>
            </td>
        </tr>
        <tr>
        ...
        <tr id="tr16">
            <td bgcolor="#EFEDDE" class="STYLE1">
                <img src="images/icon_6-.gif" width="14" height="14" />
            </td>
            <td bgcolor="#FFFFFF" class="STYLE1" onclick="fun1(document.getElementById('menus').bh,11,document.getElementById('menus').Qishu)">
                <%=GetTran("000819", "插入标签")%>1
            </td>
        </tr>
        <tr id="tr17">
            <td bgcolor="#EFEDDE" class="STYLE1">
                <img src="images/icon_9-.gif" width="14" height="14" />
            </td>
            <td bgcolor="#FFFFFF" class="STYLE1" onclick="fun1(document.getElementById('menus').bh,12,document.getElementById('menus').Qishu)">
                <%=GetTran("000819", "插入标签")%>2
            </td>
        </tr>
        <tr id="tr18">
            <td bgcolor="#EFEDDE" class="STYLE1">
                <img src="images/icon_11-.gif" width="14" height="14" />
            </td>
            <td bgcolor="#FFFFFF" class="STYLE1" onclick="fun1(document.getElementById('menus').bh,13,document.getElementById('menus').Qishu)">
                <%=GetTran("000819", "插入标签")%>3
            </td>
        </tr>
        <tr id="tr120">
            <td bgcolor="#EFEDDE" class="STYLE1">
                <img src="images/icon_7.gif" width="14" height="14" />
            </td>
            <td bgcolor="#FFFFFF" class="STYLE1" onclick="fun1(document.getElementById('menus').bh,14,document.getElementById('menus').Qishu)">
                取消标签
            </td>
        </tr>
        <tr id="tr21" style="display: none">
            ...
            <td bgcolor="#FFFFFF" class="STYLE1" onmousedown="settw(event)">
                调网
            </td>
        </tr>
        <tr id="tr22" style="display: none;">
            ...
            <td bgcolor="#FFFFFF" class="STYLE1" onclick="untw()">
                取消调网
            </td>
        </tr>
        <tr style="display: none">
            <td bgcolor="#EFEDDE" class="STYLE1">
                <img src="images/icon_10.gif" width="14" height="14" />
            </td>
            <td bgcolor="#FFFFFF" class="STYLE1">
                <a href="#">
                    <%=GetTran("000819", "插入标签")%>5</a>
            </td>
        </tr>
    </table>
    <table style="border:solid 1px; border-color:#003D5C" id="fuDong" border="0" cellspacing="0" cellpadding="0" class='tree_grid' style="position: absolute;
        width: 200px; left: 50px; top: 50px; background: #fff;">
    </table>
<!--
    <script type="text/javascript">
        //最小索引
        ...
        obj = $(".tr");
            ...
            try
            {
                fObj.animate({ "left": thisObj.children("td").eq(0).children().children(".img").offset().left + 20 + "px","top": minTr.attr("offsetTop")+83}, 100, function() {
            ...
            {
                fObj.animate({ "left": thisObj.children("td").eq(0).children().children().children(".img").offset().left + 20 + "px","top": minTr.attr("offsetTop")+83}, 100, function() {
                htmlStr += "<tr style='height:18px'><th>代数</th><th>级别</th><th>新个分数</th><th>新网分数</th><th>新网人数</th><th>总网人数</th><th>总网分数</th></tr>";
                    while (minIndex <= maxIndex) {
                        if (thisObj.css("display") != "none") {
                            objTd = obj.eq(minIndex).children("td");
            ...
            <tr>
                <td>
                        ...
                        <tbody>
                            <tr class="t_head">
                                <td style="height: 25px" colspan="2">
                                    <asp:Button ID="button1" runat="server" CssClass="anyes" Text="显示" OnClick="button1_Click">
                                    </asp:Button>&nbsp;&nbsp;&nbsp;
                                    <asp:Label ID="lbl_msg" runat="server"><%=GetTran("000045", "期数")%></asp:Label><asp:DropDownList
                                        ID="dropdownlist_qishu" runat="server">
                                    </asp:DropDownList>
                                    <%=GetTran("000024", "会员编号")%><asp:TextBox ID="txtbianhao" MaxLength="10" Width="85"
                                        runat="server"></asp:TextBox>
                                    <asp:TextBox ID="txtceng" runat="server" Width="24px"></asp:TextBox><%=GetTran("000845", "层")%>
                                    <asp:LinkButton ID="lkn_submit1" runat="server" Text="提交" Style="display: none" OnClick="lkn_submit1_Click"></asp:LinkButton>
                                    <asp:Button ID="button2" Visible="false" runat="server" CssClass="anyes" Text="回到顶部"
                                        OnClick="button2_Click"></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a style="display: none"
                                            href="javascript:window.history.back()"><u>
                                                <%=GetTran("000421", "返回")%><%=GetTran("000846", "以下图中深红色代表已审核新增人员，淡红色代表未审核新增人员")%></u></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <asp:Button ID="Button4" runat="server" Text="展开" CssClass="anyes" OnClick="Button4_Click" />
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            <td>
                                <table class="tablema">
                                    <tr>
                                        <td>
                                            <asp:Button ID="Button6" runat="server" Text="转到安置" CssClass="anyes" OnClick="Button6_Click" />
                                        </td>
                                        <td>
                                            可查看网络
                                            <asp:Repeater ID="Repeater2" runat="server">
                                                <ItemTemplate>
                                                    <b>
                                                        <%#DataBinder.Eval(Container.DataItem, "wlt")%></b>&nbsp;<span style="color: black">
                                                            / </span>&nbsp;
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </td>
                        ...
                        <tr>
                            <td class="ls2" style="font-size: 12pt" nowrap colspan="3">
                                <br />
                                <div id="statr0" style="overflow: auto; width: 100%; text-indent: 11mm; line-height: 12pt;
                                    letter-spacing: 0em;" runat="server">
                                </div>
                                <br />
                            </td>
                        </tr>
