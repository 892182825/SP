<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeductSalary.aspx.cs" Inherits="Company_DeductSalary" EnableEventValidation="false" %>
                            ...
                            <asp:GridView ID="gvdeduct" runat="server" AutoGenerateColumns="false" AllowSorting="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                                        ...
                                        <ItemTemplate>
                                            <span>
                                                <%#Eval("IsDeduct") %></span> <span>
                                                    <%#Eval("DeductMoney","{0:n4}")%>
                                                </span>
                                        </ItemTemplate>
                                    </asp:TemplateField>
