<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SST_TJ.aspx.cs" Inherits="Company_SST_TJ" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function getData(param,backM)
        {
            ...
            xmlHttp.open("get","SST_TJ.aspx?"+param,false);
        ...
        function getAsyData(param, backM) {
            ...
            xmlHttp.open("get", "SST_TJ.aspx?" + param, true);
            xmlHttp.onreadystatechange = backM;
            xmlHttp.send(null);
                    ...
                    for (var i = 0; i < arrRow.length; i++) {
                        ...
                        tdobj.onclick = function(e) {
                            ...
                            if (md.nodeName.toLowerCase() == "td")
                                window.location.href = "SST_TJ.aspx?number=" + this.parentNode.attributes["parentId"].value.replace("tr", "") + "&thNumber=" + this.childNodes[this.childNodes.length - 1].nodeValue.split(" ")[0] + "&EndNumber=<%=EndNumber%>&ExpectNum=" + _document.getElementById("DDLQs").value;
                        };
...
<body style="font-size:10pt" oncontextmenu="return false;" >
    ...
    <div style="padding-top:20px;padding-left:20px">
       ...
       <input type="button" value='<%=GetTran("000667","推荐") %>' class="anyes" disabled >
