<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoginSettingMember.aspx.cs"
    Inherits="Company_LoginSettingMember" %>
                ...
                <div>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="biaozzi">
                        <tr>
                            <td>
                               <%=GetTran("000024","会员编号") %>：
                                <asp:TextBox ID="txtNumber" runat="server" MaxLength="10" Width="80px"></asp:TextBox>&nbsp;&nbsp;
                    ...
                    <table width="100%">
                        <tr>
                            <td  style="border:rgb(147,226,244) solid 1px">
                                                <asp:GridView ID="gvBlackIP" runat="server" Width="99%" AutoGenerateColumns="False"
                        AllowSorting="True" BackColor="#F8FBFD" CssClass="tablemb bordercss" OnSorting="GridView1_Sorting"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="userid" HeaderText="会员编号"></asp:BoundField>
                        </Columns>
                        <EmptyDataTemplate>
                        </td></tr>
                                <tr>
