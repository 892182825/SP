...
<body  style="font-size:10pt">
 ...
 <%=GetTran("000045", "期数")%>：
        ...
        <asp:Button ID="Button2" runat="server" Text="常用(1)" class="anyes" Visible="false" onclientclick="return showcy1()"  />
		<%--<asp:Button ID="Button3" runat="server" Text="常用(2)" class="anyes" onclientclick="return showcy2()"  />--%>
		<asp:Button ID="Button4" runat="server" Text="常用(3)" Visible="false" class="anyes" Enabled="false"  />
