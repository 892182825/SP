<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowNotGoodViewII.aspx.cs" Inherits="Company_ShowNotGoodViewII" %>
    ...
    <script type="text/javascript">
                ...
                //if(xmlHttp.status==200)
                {
                    ...
                    for(var i=0;i<arrRow.length;i++)
                    {
                        ...
                        if(arrRow[i].getElementsByTagName("XinGe").length==1)
                        {
                            ...
                            tdobj4.appendChild(_document.createTextNode(XinGe));
        ...
        function rightMenu(e)
        {
            ...
            if(e.button==2)
            {
                ...
                {
                    _document.getElementById("sColor").innerHTML = '<%=GetTran("007854","取消变色") %>';
                    _document.getElementById("mColor").innerHTML = '<%=GetTran("007855","取消团队变色") %>';
                }
                else
                {
                    _document.getElementById("sColor").innerHTML = '<%=GetTran("000806","编号变色") %>';
                    _document.getElementById("mColor").innerHTML = '<%=GetTran("007856","团队变色") %>';
                
                }
                
                //还原
                _document.getElementById("insertImg1").innerHTML = '<%=GetTran("000819","插入标签") %>' + "1";
                _document.getElementById("insertImg4").innerHTML = '<%=GetTran("000819","插入标签") %>' + "4";
                _document.getElementById("insertImg5").innerHTML = '<%=GetTran("000819","插入标签") %>' + "5";
                _document.getElementById("insertImg3").innerHTML = '<%=GetTran("000819","插入标签") %>' + "3";
                _document.getElementById("insertImg2").innerHTML = '<%=GetTran("000819","插入标签") %>' + "2";
                ...
                for(var i=0;i<insertImg.length;i++)
                {
                    if(insertImg[i].style.backgroundImage.toLowerCase().indexOf("images/w1.ico")!=-1)
                        _document.getElementById("insertImg1").innerHTML = '<%=GetTran("007857","取消插入标签") %>' + "1";
                    if(insertImg[i].style.backgroundImage.toLowerCase().indexOf("images/w6.ico")!=-1)
                        _document.getElementById("insertImg4").innerHTML = '<%=GetTran("007857","取消插入标签") %>' + "4";
                    if(insertImg[i].style.backgroundImage.toLowerCase().indexOf("images/w7.ico")!=-1)
                        _document.getElementById("insertImg5").innerHTML = '<%=GetTran("007857","取消插入标签") %>' + "5";
                    if(insertImg[i].style.backgroundImage.toLowerCase().indexOf("images/w3.ico")!=-1)
                        _document.getElementById("insertImg3").innerHTML = '<%=GetTran("007857","取消插入标签") %>' + "3";
                    if(insertImg[i].style.backgroundImage.toLowerCase().indexOf("images/w2.ico")!=-1)
                        _document.getElementById("insertImg2").innerHTML = '<%=GetTran("007857","取消插入标签") %>' + "2";
                }
            }
        }
        ...
        function ColorBack()
        {
            if(xmlHttp.readyState==4)
            {
                if(xmlHttp.status==200)
                {
                    ...
                    {
                        var trid="tr"+_document.getElementById("hidThNumber").value;
                        if (_document.getElementById("sColor").innerHTML != '<%=GetTran("007854","取消变色") %>')
            ...
            if(xmlHttp.readyState==4)
            {
                if(xmlHttp.status==200)
                {
                    if(xmlHttp.responseText.indexOf("OK")!=-1)
                    {
                        ...
                        if (_document.getElementById("mColor").innerHTML != '<%=GetTran("007855","取消团队变色") %>')
                        {
