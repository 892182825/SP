...
using Encryption;
using DAL;
public partial class Company_DeductBDView : BLL.TranslationBase
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (this.txtbh.Text != "" && this.question.Text != "" && this.money.Text != "")
        {
            string vquestion;
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        ClientScript.RegisterStartupScript(this.GetType(), "", "<script >alert('" + GetTran("000006", "添加成功") + "！');window.location.href='DeductBD.aspx';</script>");
    ...
    public void clear()
    {
       ...
       // this.rad_Deduct.SelectedValue = "5";
    }
    /// <summary>
    /// 返回
    /// </summary>
