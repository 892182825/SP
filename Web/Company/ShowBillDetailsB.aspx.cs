...
public partial class Company_ShowBillDetailsB : BLL.TranslationBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                DataTable dt = InventoryDocDetailsBLL.GetProductsBillById(Request["DocID"].ToString());
                ...
                {
                    givDocDitals.Columns[8].Visible = false;
                    givDocDitals.Columns[9].Visible = false;
                    givDocDitals.Columns[12].Visible = false;
                    givDocDitals.Columns[13].Visible = false;
                    givDocDitals.Columns[14].Visible = false;
