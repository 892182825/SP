<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeductBDView.aspx.cs" Inherits="Company_DeductBDView" EnableEventValidation="false" %>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadioButtonList ID="rad_Deduct" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                            <asp:ListItem Value="0" Selected="True" Text="扣款"></asp:ListItem>
