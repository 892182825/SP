<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddReportProfit.aspx.cs"
    Inherits="Company_AddReportProfit" %>
     ...
     function ShowProductDiv(sender,pid)
       ...
       function  Bind()
	   {
		    var divPro = document.getElementById('product');
             ...
             var WareHouse=document.getElementById("ddlWareHouse").value;
             var DepotSeat=document.getElementById("ddlDepotSeat").value;
             divPro.innerHTML=AjaxClass.BindReporeDamage(curr,WareHouse,DepotSeat).value;
	    }
                               ...
                               <tr class="lineh">
                                ...
                                <tr class="lineh">
                                    ...
                                    <td align="left" style="white-space: nowrap">
                                     <asp:DropDownList runat="server" ID="ddlDepotSeat" Width="120px" 
                                            DataTextField="SeatName" DataValueField="DepotSeatID" 
                                            onselectedindexchanged="ddlDepotSeat_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                ...
                                <tr class="lineh">
                                    <td align="right"> <%=GetTran("000519", "经办人")%>：</td>
                                    <td>  <asp:TextBox ID="txtOperationPerson" runat="server" Width="115px" MaxLength="20" onkeyup = "ValidateValue(this)"></asp:TextBox></td>
                                </tr>
                                <tr class="lineh">
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:Button ID="btnSaveOrder" runat="server" Text="确认报溢"
