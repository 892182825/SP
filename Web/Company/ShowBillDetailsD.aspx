<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowBillDetailsD.aspx.cs" Inherits="Company_ShowBillDetailsD" %>
                ...
                CssClass="tablemb bordercss" OnRowDataBound="givDoc_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="单据编号" ShowHeader="False">
                                     ...
                                     <asp:TemplateField HeaderText="报溢仓库" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <span><%#Eval("warehousename")%></span></ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="报溢库位" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <span>
                                        <%#Eval("seatname") %></span></ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="报溢时间"  HeaderStyle-Wrap="false" ItemStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <span>
    ...
    <br />
        <table width="100%">
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="币种" Visible="false" DataField="DocID" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false" HeaderStyle-Wrap="false"></asp:BoundField>
