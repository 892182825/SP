<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberRestoreoff.aspx.cs"
    Inherits="Company_MemberRestoreoff" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
	 ...
	 var aa=[
        ...
        '<%=GetTran("001318", "您确定要恢复该会员的注销状态吗")%>'
    ];
