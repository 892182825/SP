<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoginSettingArea.aspx.cs"
    Inherits="AreaBlackGroup" EnableEventValidation="false" %>
            ...
            <td valign="top">
                ...
                <div>
                    <table border="0" cellpadding="0" cellspacing="0" class="biaozzi">
                        <tr>
                            <td >
                                <%=GetTran("000447","请选择区域：") %>
                            </td>
                            <td><uc1:CountryCity ID="CountryCity1" runat="server" /></td>
                            <td align="left">&nbsp;&nbsp;
                                <asp:Button ID="Add_blackList" runat="server" Text="添加到黑名单" OnClick="Add_blackList_Click"
                                    CssClass="another"></asp:Button>&nbsp;&nbsp;<asp:Button ID="btAddToBlackList" runat="server" Text="删除黑名单" OnClick="btAddToBlackList_Click"
                    ...
                    <asp:GridView ID="gvBlackArea" runat="server" Width="100%" AutoGenerateColumns="False"
                        AllowSorting="True" OnSorting="GridView1_Sorting" OnRowDataBound="gvBlackArea_RowDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="国家">
                                <ItemTemplate>
                                    <asp:Label ID="lblCountry" runat="server" Text='<%# GetArea(Eval("GroupValue"),0) %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="省份">
                                <ItemTemplate>
                                    <asp:Label ID="lblPriv" runat="server" Text='<%# GetArea(Eval("GroupValue"),1) %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="城市">
                                <ItemTemplate>
                                    <asp:Label ID="lblCity" runat="server" Text='<%# GetArea(Eval("GroupValue"),2) %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <EmptyDataTemplate>
                                ...
                                <tr>
                                    <td valign="bottom" style="padding-left: 20px">
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    1、<%=GetTran("000773", "设置某一地区的会员不能登录系统")%>。
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
