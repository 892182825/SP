<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageInEdit.aspx.cs" Inherits="Company_StorageInEdit" %>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff"
                                ...
                                <tr class="lineh">
                                    <td valign="bottom" colspan="2" align="left">
                                        ...
                                        <b><%=GetTran("004154", "请修改您要入库的产品清单")%></b>
                                        <br />
                                    </td>
                                </tr>
                                <tr class="lineh">
                                ...
                                <tr>
                                    ...
                                    <td><asp:DropDownList ID="ddlCountry" runat="server" Enabled="false" AutoPostBack="true"
                               ...
                               <tr class="lineh">
                                ...
                                <tr class="lineh">
                                    <td align="right"><%=GetTran("000658","批次")%>：</td>
                                    <td>
                                        <asp:TextBox ID="txtpici" Width="115px" runat="server" MaxLength="20" onkeyup = "ValidateValue(this)"></asp:TextBox><font color="red">*必填</font>
