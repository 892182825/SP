<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dlssetnow.aspx.cs" Inherits="Company_Dlssetnow" EnableEventValidation="false"%>
                       ...
                       <%-- <td style="white-space: nowrap;">
                        ...
                        <td style="display:none;">
                            <asp:DropDownList ID="DropDownList1" runat="server">
                                ...
                                <asp:ListItem Value="0">扣款</asp:ListItem>
                                <asp:ListItem Value="1">补款</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
                        &nbsp;&nbsp;<%=GetTran("001889","的")%>&nbsp;
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownList2" runat="server" Width="84px">
                                ...
                                <asp:ListItem Value="Dls_bl.opbh">代理商编号</asp:ListItem>
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# Eval("ischek") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                   ...
                                   <asp:BoundField HeaderText="比例" DataField="bl" SortExpression="bl" />
                                    <asp:BoundField HeaderText="期数" DataField="qs" SortExpression="qs" />
                                    
                                    <asp:BoundField HeaderText="代理商编号" DataField="opbh" />
                                    <asp:TemplateField HeaderText="审核状态">
                                        <ItemTemplate>
                                            <%#Eval("ischek").ToString() == "0" ? GetTran("001009", "未审核") : GetTran("001011", "已审核")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
