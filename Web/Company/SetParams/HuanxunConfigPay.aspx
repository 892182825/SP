<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HuanxunConfigPay.aspx.cs" Inherits="HuanxunConfigPay" %>
        ...
        <table border="0" width="98%" class="tb" cellpadding="0" cellspacing="0">
            <tr>
                <td class="style1" style="background-image: url(../images/tabledp.gif); color: White;
                    height: 25px;">
                   <%=GetTran("007938", "环迅网关设置")%>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="tdL">
                        <span class="style2">*</span><%=GetTran("007939", "环迅网关商户号")%>
                        ：
                    </div>
                    <div class="tdC">
            ...
            <tr>
                <td>
                    <div class="tdL">
                      <span class="style2">*</span> <%=GetTran("007940", "环迅网关证书号")%>：</div>
                    <div class="tdC">
