<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfigQuickPay.aspx.cs" Inherits="Company_SetParams_ConfigQuickPay" %>
        ...
        <table border="0" width="98%" class="tb" cellpadding="0" cellspacing="0">
            <tr>
                <td class="style1" style="background-image: url(../images/tabledp.gif); color: White;
                    height: 25px;">
                    <%=GetTran("006679", "快钱网关设置")%>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="tdL">
                        <span class="style2">*</span><span title='人民币网关账户'><%=GetTran("006678", "人民币网关账户")%></span>
                        ：
                    </div>
                    <div class="tdC">
            ...
            <tr>
                <td>
                    <div class="tdL">
                        <span title='人民币网关密钥'>
                            <%=GetTran("006677", "人民币网关密钥")%></span>：</div>
                    <div class="tdC">
                        <asp:TextBox ID="txtKey" runat="server" Width="145px" MaxLength="20" TextMode="Password"></asp:TextBox>
            ...
            <tr>
                <td>
                    ...
                    <div class="tdC">
                        <asp:TextBox ID="txtPageUrl" runat="server" Width="145px" MaxLength="100" ></asp:TextBox>
                        <asp:Label runat="server" ID="lblPageUrl" ForeColor="#FF0066"></asp:Label></div>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td class="tdh">
                    ...
                    &nbsp;
                    <input id="Button1" type="reset" title="重置" value='<%=GetTran("006812", "重置")%>'
                        class="anyes" />&nbsp;
