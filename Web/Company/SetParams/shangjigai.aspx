<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shangjigai.aspx.cs" Inherits="Company_SetParams_ExchangeTime" %>
    ...
    <div>
        <table width="300px" align="center" cellpadding="0" cellspacing="3" class="tablemb">
            ...
            <tr>
               <td align="right">姓名：</td>
                <td>
                    <asp:Label ID="xiajiname" runat="server" MaxLength="10"></asp:Label>
                </td>
            </tr>
