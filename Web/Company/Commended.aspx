<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Commended.aspx.cs" Inherits="Company_Commended" %>
                            ...
                            <table width="90%" border="0" cellpadding="0" cellspacing="0" class="biaozzi">
                                <tr>
                                    ...
                                    <RowStyle HorizontalAlign="Center" />
                                            ...
                                            <Columns>
                                                <asp:BoundField HeaderText="会员编号" DataField="hybh" ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                                                    <HeaderStyle Wrap="False"></HeaderStyle>
                                                    <ItemStyle Wrap="False"></ItemStyle>
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="小区编号" DataField="xjbh" ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                                                    <HeaderStyle Wrap="False"></HeaderStyle>
                                                    <ItemStyle Wrap="False"></ItemStyle>
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="报单编号" DataField="bdbh" ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                                                    <HeaderStyle Wrap="False"></HeaderStyle>
                                                    <ItemStyle Wrap="False"></ItemStyle>
                                                </asp:BoundField>
