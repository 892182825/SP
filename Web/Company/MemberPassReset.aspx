<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberPassReset.aspx.cs" Inherits="Company_MemberPassReset" EnableEventValidation="false" %>
        ...
        <tr>
            <td>
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <%--        &nbsp;<%=GetTran("000030", "所属服务机构")%>：<asp:TextBox ID="TextBox1" runat="server" Width="80px"
                                MaxLength="50"></asp:TextBox>--%>
                        ...
                        <td valign="top">
                            <asp:GridView ID="GridView1" runat="server" Width="100%" AllowSorting="true" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                   ...
                                   <%-- <asp:BoundField DataField="StoreID" HeaderText="所属店铺"></asp:BoundField>--%>
