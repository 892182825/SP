<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResultBrowse2.aspx.cs" Inherits="Company_ResultBrowse2" %>
    ...
    <div>
            ...
            <tr>
                <td>
                    <asp:RadioButtonList ID="RadioButtonList2" runat="server" AutoPostBack="True" OnSelectedIndexChanged="RadioButtonList2_SelectedIndexChanged"
                        ...
                        <asp:ListItem Value="1" Selected="True">服务机构订货款明细</asp:ListItem>
                        <asp:ListItem Value="2">服务机构周转款明细</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>
        </table>
        <table border="0" cellpadding="0" cellspacing="0" class="biaozzi" style="word-break: keep-all;
            ...
            <tr>
                ...
                <td>
                    &nbsp;<%=GetTran("007865", "并且服务机构编号为")%>：<asp:TextBox ID="TxtBh" runat="server"></asp:TextBox></asp:AccessDataSource>
                </td>
            </tr>
        </table>
        <br />
                ...
                <td style="word-break: keep-all; word-wrap: normal">
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridView2_RowDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="happentime" HeaderText="发生时间" ItemStyle-Wrap="false" />
                            <asp:TemplateField HeaderText="转入金额">
                                <ItemTemplate>
                                    <%#Eval("Direction").ToString()=="0"? double.Parse(Eval("happenmoney").ToString()).ToString("0.00"):"" %>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="转出金额">
                                <ItemTemplate>
                                    <%#Eval("Direction").ToString()=="1"? Math.Abs(double.Parse(Eval("happenmoney").ToString())).ToString("0.00"):"" %>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="Balancemoney" HeaderText="结余金额" DataFormatString="{0:f2}"
