...
public partial class Company_SetAgreement : BLL.TranslationBase
{
    ...
    {
        TextBox1.Text = DAL.CommonDataDAL.GetAgreement(CountryCode, LanguageCode,0);// CommonDataBLL.GetAgreement(CountryCode, LanguageCode); 
    }
    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        ...
        if (CommonDataBLL.RegisterAgreement(Agreement, CountryCode, LanguageCode,0) == 1)
        {
