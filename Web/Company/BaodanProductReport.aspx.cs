...
public partial class Company_BaodanProductReport : BLL.TranslationBase
{
    ...
    private void getdata()
    {
        ...
        dt = DBHelper.ExecuteDataTable("H_mingxi_getData", param, CommandType.StoredProcedure);
    ...
    private string Bind()
    {
        ...
        this.Builder.Append("<TD align=center width=90 rowSpan=3>" + GetTran("000501", "产品名称") + "</TD>");
        ...
        this.Builder.Append("<TD align=center width=60>" + GetTran("000521", "未支付") + "</TD>");
        this.Builder.Append("<TD align=center width=70>" + GetTran("000534", "小计") + "</TD>");
        this.Builder.Append("<TD align=center width=70>" + GetTran("000517", "已支付") + "</TD>");
        this.Builder.Append("<TD align=center width=60>" + GetTran("000521", "未支付") + "</TD>");
        this.Builder.Append("<TD align=center width=80>" + GetTran("000534", "小计") + "</TD>");
        this.Builder.Append("<TD align=center width=80>" + GetTran("000517", "已支付") + "</TD>");
        this.Builder.Append("<TD align=center width=60>" + GetTran("000521", "未支付") + "</TD>");
        ...
        this.Builder.Append("<td width=60 align=center><FONT face=\"宋体\" style=\"FONT-WEIGHT: bold; COLOR: black\">" + GetTran("000630", "合计") + "</font></td>");
        this.Builder.Append("<Td width=90>" + space + "</td>");
        ...
        this.Builder.Append("<td width=60 align=right><FONT face=\"宋体\" style=\"FONT-WEIGHT: bold; COLOR: black\">" + getstr(htColumntotal[2].ToString()) + "</font></td>");
        this.Builder.Append("<td width=70 align=right><FONT face=\"宋体\" style=\"FONT-WEIGHT: bold; COLOR: black\">" + getstr(htColumntotal[3].ToString()) + "</font></td>");
        this.Builder.Append("<td width=70 align=right><FONT face=\"宋体\" style=\"FONT-WEIGHT: bold; COLOR: black\">" + getstr(htColumntotal[4].ToString()) + "</font></td>");
        this.Builder.Append("<td width=60 align=right><FONT face=\"宋体\" style=\"FONT-WEIGHT: bold; COLOR: black\">" + getstr(htColumntotal[5].ToString()) + "</font></td>");
        ...
        this.Builder.Append("<td width=60 align=right><FONT face=\"宋体\" style=\"FONT-WEIGHT: bold; COLOR: black\">" + getstr(htColumntotal[8].ToString()) + "</font></td>");
        this.Builder.Append("<td width=70 align=right><FONT face=\"宋体\" style=\"FONT-WEIGHT: bold; COLOR: black\">" + getstr(htColumntotal[9].ToString()) + "</font></td>");
        this.Builder.Append("<td width=70 align=right><FONT face=\"宋体\" style=\"FONT-WEIGHT: bold; COLOR: black\">" + getstr(htColumntotal[10].ToString()) + "</font></td>");
        this.Builder.Append("<td width=60 align=right><FONT face=\"宋体\" style=\"FONT-WEIGHT: bold; COLOR: black\">" + getstr(htColumntotal[11].ToString()) + "</font></td>");
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            this.Builder.Append("<td width=60 align=center>" + dt.Rows[i]["productcode"].ToString() + "</td>");
            this.Builder.Append("<td width=90 align=center>" + dt.Rows[i]["ProductName"].ToString() + "</td>");
            ...
            this.Builder.Append("<td width=60 align=right >" + getstr(dt.Rows[i]["LFNCheckOut"].ToString()) + "</td>");
            this.Builder.Append("<td width=70 align=right >" + getstr(dt.Rows[i]["LAbaodan"].ToString()) + "</td>");
            this.Builder.Append("<td width=70 align=right >" + getstr(dt.Rows[i]["LACheckOut"].ToString()) + "</td>");
            this.Builder.Append("<td width=60 align=right >" + getstr(dt.Rows[i]["LANCheckOut"].ToString()) + "</td>");
            ...
            this.Builder.Append("<td width=60 align=right >" + getstr(dt.Rows[i]["BFNCheckOut"].ToString()) + "</td>");
            this.Builder.Append("<td width=70 align=right >" + getstr(dt.Rows[i]["BAbaodan"].ToString()) + "</td>");
            this.Builder.Append("<td width=70 align=right >" + getstr(dt.Rows[i]["BACheckOut"].ToString()) + "</td>");
            this.Builder.Append("<td width=60 align=right >" + getstr(dt.Rows[i]["BANCheckOut"].ToString()) + "</td>");
