...
public partial class Company_SMSContent : BLL.TranslationBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Permissions.CheckManagePermission(6311);     
    ...
    {        
        ...
        lblmenu.Text = pTree.GetSMSProductTree(ddlCountry.SelectedValue);
