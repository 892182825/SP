<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xiaoqujiang.aspx.cs" Inherits="Company_xiaoqujiang" %>
                                ...
                                <tr>
                                    ...
                                    <RowStyle HorizontalAlign="Center" />
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="小区业绩" DataField="TotalPV" ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                                                    <HeaderStyle Wrap="False"></HeaderStyle>
                                                    <ItemStyle Wrap="False"></ItemStyle>
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="比例" DataField="bili" ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                                                    <HeaderStyle Wrap="False"></HeaderStyle>
                                                    <ItemStyle Wrap="False"></ItemStyle>
                                                </asp:BoundField>
...
<%--                                                <asp:BoundField  HeaderText="会员编号" DataField="number"/>
                                                 ...
                                                 <asp:BoundField  HeaderText="小区业绩" DataField="TotalPV"/>
                                                 <asp:BoundField  HeaderText="比例" DataField="bili"/>
