<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageAffiche.aspx.cs" ValidateRequest="false" Inherits="Company_ManageAffiche" %>
                                    ...
                                    <tr>
                                        ...
                                        <td id="td_GongGao" runat="server" style="white-space:nowrap">
                                            ...
                                            <asp:Label ID="Label2" runat="server"><%=GetTran("001684", "收件人编号")%>：</asp:Label><asp:TextBox ID="txtBianhao"
                                                ...
                                                <asp:Label ID="Label1" runat="server">(<%=GetTran("001574", "信件群发时 , 编号用 ' , ' 分隔(如:001,002),发给所有成员请用公告发布")%>)</asp:Label>
                                        </td>
                                        </tr>
                                        <tr>
                                        <td id="td_ReceiveRange" runat="server" style="white-space:nowrap">
                                            ...
                                            <%--<asp:CheckBox ID="ChkLevel" runat="server" 
                                                oncheckedchanged="ChkLevel_CheckedChanged" AutoPostBack="True"></asp:CheckBox>:
                                            <asp:DropDownList ID="DropLevel" runat="server">
                                            </asp:DropDownList> --%>
                                             &nbsp;
                                            <asp:CheckBox ID="ChkBonus" runat="server" 
                                                oncheckedchanged="ChkBonus_CheckedChanged" AutoPostBack="True"></asp:CheckBox>：
                                            <asp:TextBox ID="TxtBonusFrom" runat="server" MaxLength="10" Width="80px" onkeyup = "ValidateValue(this)"></asp:TextBox>
                                            <asp:Label ID="LblTo" runat="server" Text="~"></asp:Label><asp:TextBox ID="TxtBonusTo" runat="server" MaxLength="10" Width="80px" onkeyup = "ValidateValue(this)"></asp:TextBox>
                                            <asp:CheckBox ID="ChkNet" runat="server" 
                                                 AutoPostBack="True" oncheckedchanged="ChkNet_CheckedChanged"></asp:CheckBox>：
                    ...
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            <td valign="top" align="center" style="word-spacing:normal">
                                ...
                                <div class="editor">
                               <textarea id="content1" rows="8"  runat="server" style="VISIBILITY: hidden; WIDTH: 700px; HEIGHT: 350px" name="content"></textarea>
