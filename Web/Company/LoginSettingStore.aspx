<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoginSettingStore.aspx.cs"
    Inherits="LoginSettingStore" %>
                ...
                <div>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="biaozzi">
                        <tr>
                            <td >
                                <%=GetTran("000150", "店铺编号")%>：
                                <asp:TextBox ID="txtStoreID" runat="server" MaxLength="10" Width="80px"></asp:TextBox>
                        ...
                        <tr>
                            <td style="border:rgb(147,226,244) solid 1px">
                             <asp:GridView ID="gvBlackStore" runat="server" Width="100%" OnRowDataBound="GvBlackStore_RowDataBound"
                        AutoGenerateColumns="False" BackColor="#F8FBFD" CssClass="tablemb bordercss">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="userid" HeaderText="店铺编号"></asp:BoundField>
                            <asp:TemplateField>
