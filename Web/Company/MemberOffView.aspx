<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberOffView.aspx.cs" Inherits="Company_MemberOffView" %>
    ...
    <div>
                    ...
                    <table class="biaozzi">
                        <tr>
                            <td nowrap="nowrap" style="display: none;">
                                <asp:Button ID="btnWL" runat="server" Text="会员注销" OnClick="btnWL_Click" CssClass="another" />
                            </td>
                            <td>
                                &nbsp;&nbsp;&nbsp;
                            ...
                            <td nowrap="nowrap">
                                <%=GetTran("001277", "注销状态")%>：<asp:DropDownList ID="DropDownList1" runat="server">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="详细信息" HeaderStyle-Wrap="false" Visible="false">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="lbtn_Select" runat="server" CommandName='<%#Eval("Number") %>'
                                                    OnCommand="lbtn_Select_Click" Text='<%#GetTran("000035", "详细信息") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="注销原因" HeaderStyle-Wrap="false">
                                            <ItemTemplate>
                                                <label id="lbloffReason1" title='<%=GetTran("007164","注销原因") %>'>
        ...
        <div id="divOffReason" style="position: absolute; left: 0px; top: 00px; width: 300px;
            ...
            <div id="divOff" style="width: 100%; height: 80%; text-align: center;">
                <textarea id="lblOffReason" readonly="readonly" style="width: 98%; height: 88%;"
                    rows="4"></textarea>
