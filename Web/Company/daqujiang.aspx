<%@ Page Language="C#" AutoEventWireup="true" CodeFile="daqujiang.aspx.cs" Inherits="Company_daqujiang" %>
                    ...
                    <tr>
                        <td>
                            <table width="90%" border="0" cellpadding="0" cellspacing="0" class="biaozzi">
                                <tr>
                                    <th align="left" style="word-break: keep-all; word-wrap: normal">
                                    ...
                                    <RowStyle HorizontalAlign="Center" />
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="大区业绩" DataField="TotalPV" ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                                                    <HeaderStyle Wrap="False"></HeaderStyle>
                                                    <ItemStyle Wrap="False"></ItemStyle>
                                                </asp:BoundField>
