...
public partial class Company_OrderGoodsDetail : BLL.TranslationBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            GridView1.DataSource = new OrdersBrowseBLL().OrderGoodsDataTable_III(storeOrderID);
            GridView1.DataBind();

            DataTable dt = OrdersBrowseBLL.StoreOrderGoodsDT(storeOrderID);
