        ...
        <tr>
            <td>
                <asp:GridView ID="givStoreInfo" runat="server" AutoGenerateColumns="False" CssClass="tablemb"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="操作" ShowHeader="False" ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                            <asp:LinkButton ID="btndel" runat="server" CausesValidation="false" CommandName="del"
                                    CommandArgument='<%#Eval("StoreID")+","+Eval("number") %>'><%# GetTran("000022", "删除")%></asp:LinkButton>
                                <asp:LinkButton ID="btnqueren" runat="server" CausesValidation="false" CommandName="queren"
                                    CommandArgument='<%#Eval("StoreID")+","+Eval("number") %>' ><%# GetTran("000064", "确认")%></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="TotalInvestMoney" HeaderText="总金额(万元)" ItemStyle-Wrap="false"
