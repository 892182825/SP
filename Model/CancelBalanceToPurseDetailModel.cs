 ...
 * 创建者：     汪华
 * 创建时间：   2009-08-30 
 * 文件名：     CancelBalanceToPurseDetailModel
 * 功能：       奖金发放撤销记录表
 */

namespace Model
{
    public class CancelBalanceToPurseDetailModel
    {
            public CancelBalanceToPurseDetailModel()
        { }

            public CancelBalanceToPurseDetailModel(int id)
        {
            this.iD = id;
        }
        ...
        private DateTime transferToAccountDate;

        /// <summary>
        /// 奖金转电子账户日期
        /// </summary>
        public DateTime TransferToAccountDate
        {
          get { return transferToAccountDate; }
          set { transferToAccountDate = value; }
        }
